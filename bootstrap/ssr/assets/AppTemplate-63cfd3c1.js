...
import { mergeProps, unref, withCtx, createTextVNode, useSSRContext, createVNode, toDisplayString, ref } from "vue";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["ps-menu--slidebar", ["ps-menu--slidebar", { "active": _ctx.isMenuOpen }]]
