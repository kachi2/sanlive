...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    function UpdateAddress(address) {
      form.post("/account/address/update/" + address.hashid, {
        onSuccess: (page) => {
                  ...
                  createVNode("div", { class: "ps-shopping__content" }, [
                    createVNode("div", { class: "row" }, [
                      ...
                      createVNode("div", {
                        ...
                        createVNode("form", {
                          action: "",
                          onSubmit: withModifiers(($event) => UpdateAddress(__props.address), ["prevent"])
                        }, [
                          createVNode("div", { class: "row" }, [
                            createVNode("div", {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Users/Accounts/editAddress.vue");
