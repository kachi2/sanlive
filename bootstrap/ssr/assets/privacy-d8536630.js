...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props;
    console.log(props.privacy.content);
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AppTemplate, null, {
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="ps-about"${_scopeId}><div class="container"${_scopeId}><ul class="ps-breadcrumb"${_scopeId}><li class="ps-breadcrumb__item"${_scopeId}><a href=""${_scopeId}>Home</a></li><li class="ps-breadcrumb__item active" aria-current="page"${_scopeId}>Privacy Policy</li></ul></div><div class="ps-about__content"${_scopeId}><section class="ps-about__project"${_scopeId}><div class="container"${_scopeId}><section class="ps-section"${_scopeId}><div class="ps-section__cntent"${_scopeId}><p${_scopeId}>${__props.privacy.content ?? ""}</p></div></section></div></section></div></div>`);
          } else {
            return [
                    ...
                    createVNode("div", { class: "container" }, [
                      createVNode("section", { class: "ps-section" }, [
                        createVNode("div", { class: "ps-section__cntent" }, [
                          createVNode("p", {
                            innerHTML: __props.privacy.content
                          }, null, 8, ["innerHTML"])
                        ])
                      ])
                    ])
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Users/Pages/privacy.vue");
