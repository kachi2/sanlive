                     ...
                     <div class="ps-section__product shadow-sm "  >
                        <div class="ps-product ps-product--standard cart-card  border-gray-800 " style="background-color:#fff">
                            <div class="ps-product__thumbnail ">
                                <Link class="ps-product__image" :href="`/products/${product.productUrl}-${product.hashid}`" style="max-height:250px">
                                    <figure>
                            ...
                            <div class="ps-product__content">
                                <h5 class=""><Link :href="`/products/${product.productUrl}-${product.hashid}`"> {{ product.name }}</Link>
                                </h5>
                                ...
                                <span class="download-note"> 
                                    <span >  <Link  class=" btn btn-lg"  :href="`/products/${product.productUrl}-${product.hashid}`"  style="background:#fff; color:#73c2fb; border:1px solid #73c2fb; width:100px="> <i class="fa fa-plus"> </i> Add to basket</Link>  
