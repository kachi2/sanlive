...
<div class="ps-navigation--footer">
    ...
    <div class="ps-nav__item"><a style="color:#000; height:0px" href=""><i class="icon-home2"></i></a>
    <small> Home</small></div>
    <div class="ps-nav__item"><a  style="color:#000; height:0px" href=""><i class="icon-user"></i></a>
    <small> Account</small></div>
    <div class="ps-nav__item"><a style="color:#000; height:0px; width:49px" href=""><i class="icon-cart-empty"></i><span class="badge cartReload"></span></a>
    <small>Cart </small>
    </div>
